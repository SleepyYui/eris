...
class Client extends EventEmitter {
    ...
    * @arg {ForumTag[]} [options.availableTags] The available tags of the channel (forum channels only)
    * @arg {String} [options.defaultReactionEmoji] The default reaction emoji of the channel (forum channels only)
    * @arg {Number} [options.defaultSortOrder] The default sort order of the channel (forum channels only)
    * @arg {Number} [options.defaultForumLayout] The default forum layout of the channel (forum channels only)
    * @arg {String} [reason] The reason to be displayed in audit logs
    * @returns {Promise<CategoryChannel | GroupChannel | TextChannel | TextVoiceChannel | NewsChannel | NewsThreadChannel | PrivateThreadChannel | PublicThreadChannel | ForumChannel>}
    */
    ...
    * @arg {String} channelID The ID of the channel
    * @returns {CategoryChannel | GroupChannel | PrivateChannel | TextChannel | TextVoiceChannel | NewsChannel | NewsThreadChannel | PrivateThreadChannel | PublicThreadChannel | ForumChannel}
    */
