...
/**
* Represents a guild channel. You also probably want to look at CategoryChannel, NewsChannel, TextChannel, and TextVoiceChannel. See Channel for extra properties.
* @extends Channel
...
class GuildChannel extends Channel {
    ...
    * @arg {ForumTag[]} [options.tags] The tags of the channel (forum channels only)
    * @arg {String} [reason] The reason to be displayed in audit logs
